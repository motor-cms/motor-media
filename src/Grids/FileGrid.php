...
class FileGrid extends Grid
{
    ...
    {
        $this->addColumn('preview', trans('motor-media::backend/files.file'))->renderer(FileRenderer::class, ['file' => 'file']);
        $this->addColumn('preview_name', trans('motor-media::backend/files.file_info'))->renderer(FileRenderer::class, ['file' => 'file', 'name_only' => true]);
        ...
        $this->addColumn('categories', trans('motor-backend::backend/categories.categories'), true)->renderer(CollectionRenderer::class, ['column' => 'name']);
